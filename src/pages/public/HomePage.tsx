  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <footer id="footer" className="bg-gray-900 text-white">
        <div className={`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 transition-all duration-1000 ${
          visibleSections.has('footer') ? 'animate-slideInUp opacity-100' : 'opacity-0 translate-y-10'
        }`}>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-8">
                ...
                <span className="text-3xl font-bold">SecuriTel</span>
              </div>
              <p className="text-gray-400 mb-8 max-w-md leading-relaxed">
                La première plateforme de protection des téléphones au Bénin. 
                Sécurisez vos appareils contre le vol, la perte et les arnaques.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/phones/register" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">Enregistrer un téléphone</Link></li>
                <li><Link to="/verify" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">Vérifier un IMEI</Link></li>
                <li><Link to="/report/theft" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">Signaler un vol</Link></li>
                <li><Link to="/phones" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-2 inline-block">Mes téléphones</Link></li>
              </ul>
            </div>
